...
|---|---|---|
 ...
 |  "Computational Thinking is the thought processes involved in formulating problems and their solutions so that the solutions are represented in a form that can be effectively carried out by an information-processing agent." Like a source code is a Model computeer. and information processing agent example is human and computer? why computer because the computer like the human imitation, and cause that the programer make a AI jeannetet M wing Carniege Mellon Univeristy,form Youtube bukalapak Inggriani lime(mrs Inge) 13 july 2018 And computatuinal thingking has a techniques for us to learn that example Four key techniques (cornerstones) to CT:  decomposition - breaking down a complex problem or system into smaller, more manageable parts  pattern reconition - looking for similarities among and within problems abstraction-focusing on the important information only.ignoring irrelevant detail algorithms developing a step-by- step solution to the problem, or the rules to follow to solve the proble Examples of things we usually do every day Cooking Fried Noodle  Decomposition: in the initial stage of noodles, we usually prepare steps to solve the problem by preparing ½ liter in the pan Pattern recognition: pattern recognition by understanding the process of cooking noodles from boiling the water first, opening the noodle wrapper, opening the seasoning packet until the noodles are drained and put on the plate.  Abstract: a view of how much water is needed to cook noodles and how long it takes for the noodles to cook  Algorithm: already understand the pattern from above, add enough water, heat the water, open the package of noodles and seasonings, then add the noodles and wait a few moments until the noodles are cooked
| |
